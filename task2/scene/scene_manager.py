...
class SceneManager:
    ...
    def make_camera_viewport_active(self, actor_name: str, entity_name: str) -> None:
        """打开 OrcaStudio 相机视口。官方 API：env/scene.make_camera_viewport_active。"""
        self._scene.make_camera_viewport_active(actor_name, entity_name)
